  ...
  <div class="property-panel" ref="propertyPanel">
    <a-form-model :model="form" :label-col=" { span: 6 }" :wrapper-col="{ span: 14 }">
      ...
      <a-form-model-item label="节点名称">
        <a-input v-model="form.name" @input="nameChange"></a-input>
      </a-form-model-item>
      <a-form-model-item label="节点颜色">
        <!-- <a-input v-model="form.color" @input="nameChange"></a-input> -->
      </a-form-model-item>
      <a-form-item label="节点人员" v-if="userTask">
        <a-select v-model="form.userType" placeholder="请选择" @change="typeChange">
          <a-select-option value="assignee" label="指定人员"></a-select-option >
          <a-select-option value="candidateUsers" label="候选人员"></a-select-option >
          <a-select-option value="candidateGroups" label="角色/岗位"></a-select-option >
        </a-select>
      </a-form-item>
    </a-form-model>
